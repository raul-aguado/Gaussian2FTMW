...
if opt1 == "1":
    ...
    opt2 = input("Select task... ")
    mem = input("Select memory to use (mB)...")
    nproc = input("Select the number of processors to use... ")
    ...
    if opt2 == "2":
        ...
        for fp in filepaths:
            ...
            if ext == ".xyz":
                ...
                com_file.write("%nproc=" + nproc + "\n")
                com_file.write("%chk=" + fp.replace(".xyz", ".chk") + "\n")
                com_file.write("#B3LYP/6-311++G(d,p) output=(pickett,wfn)\n")
                com_file.write(os.linesep)
                com_file.write(fp + "\n")
                com_file.write(os.linesep)
                com_file.write("0 1" + os.linesep)
